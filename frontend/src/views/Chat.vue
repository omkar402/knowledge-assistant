<template>
  <div class="h-full flex relative">
    ...
    >
      ...
      <div class="flex-1 overflow-y-auto">
        ...
        <div
          ...
          class="p-8 text-center text-dark-500"
        >
        ...
        <div v-else class="divide-y divide-dark-200 dark:divide-dark-700">
          ...
          >
            <div class="flex items-start gap-3">
              ...
              >
                <span v-if="chat.knowledgeBase?.icon">{{
                  chat.knowledgeBase.icon
                }}</span>
              ...
              <div class="flex-1 min-w-0">
                <p
                  class="text-sm font-medium text-dark-900 dark:text-white truncate"
                >
                  {{ chat.title }}
                </p>
    ...
    <div class="flex-1 flex flex-col min-w-0">
      <!-- Chat header -->
      <div
        class="h-14 px-4 border-b border-dark-200 dark:border-dark-700 flex items-center justify-between"
      >
        ...
        <div class="flex items-center gap-2">
          <select v-model="selectedModel" class="input text-sm w-64">
      ...
      <div ref="messagesContainer" class="flex-1 overflow-y-auto p-4 space-y-4">
        ...
        >
          <div
            class="w-16 h-16 mx-auto mb-6 bg-primary-100 dark:bg-primary-900/30 rounded-2xl flex items-center justify-center"
          >
            <SparklesIcon
        ...
        >
          ...
          >
            ...
            <div
              ...
              class="mt-3 pt-3 border-t border-dark-200 dark:border-dark-700"
            >
    ...
    <Teleport to="body">
      ...
      >
        <div
          class="bg-white dark:bg-dark-800 rounded-xl shadow-xl w-full max-w-sm p-6"
        >
          ...
          <p class="text-sm text-dark-600 dark:text-dark-300 mb-6">
            Delete "<span class="font-medium truncate">{{
              deleteModal.title
            }}</span
            >"?
          </p>
          <div class="flex gap-3 justify-end">
            <button @click="deleteModal.show = false" class="btn-secondary">
              Cancel
            </button>
            <button
              @click="deleteChat"
...
const MODELS = [
  ...
  // { value: "gpt-4.1-nano", label: "GPT-4.1 Nano (Lightweight)" },
...
const selectedModel = ref("meta-llama/Llama-3.1-8B-Instruct");
...
onMounted(async () => {
  await Promise.all([loadChats(), loadKnowledgeBases()]);
