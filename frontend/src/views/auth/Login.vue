    ...
    <div class="hidden lg:flex lg:w-1/2 bg-primary-600 items-center justify-center p-12">
      <div class="max-w-md text-center">
        ...
        <p class="text-primary-100 text-lg">
          Your AI-powered research companion. Organize, search, and extract insights from your documents.
        </p>
      </div>
    </div>
          ...
          <form @submit.prevent="handleSubmit" class="space-y-4">
            ...
            <div class="flex items-center justify-between">
              <label class="flex items-center gap-2 cursor-pointer">
                <input type="checkbox" v-model="form.remember" class="rounded border-dark-300">
